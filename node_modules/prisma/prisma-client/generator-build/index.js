  ...
  "../../node_modules/.pnpm/semver@5.7.1/node_modules/semver/semver.js"(exports, module2) {
    ...
    function replaceTilde(comp, options2) {
      ...
      return comp.replace(r3, function(_, M, m3, p3, pr) {
        debug10("tilde", comp, _, M, m3, p3, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m3)) {
    ...
    function replaceCaret(comp, options2) {
      ...
      return comp.replace(r3, function(_, M, m3, p3, pr) {
        debug10("caret", comp, _, M, m3, p3, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m3)) {
    ...
    function replaceXRange(comp, options2) {
      ...
      return comp.replace(r3, function(ret, gtlt, M, m3, p3, pr) {
        debug10("xRange", comp, ret, gtlt, M, m3, p3, pr);
        var xM = isX(M);
        var xm = xM || isX(m3);
        var xp = xm || isX(p3);
        var anyX = xp;
...
var require_fs = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/fs/index.js"(exports) {
    ...
    api.forEach((method2) => {
      exports[method2] = u(fs13[method2]);
    });
...
var require_empty = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/empty/index.js"(exports, module2) {
    ...
    var emptyDir = u(/* @__PURE__ */ __name(async function emptyDir2(dir2) {
      let items;
      try {
...
var require_semver2 = __commonJS({
  "../../node_modules/.pnpm/semver@6.3.0/node_modules/semver/semver.js"(exports, module2) {
    ...
    Range.prototype.parseRange = function(range) {
      ...
      debug10("comparator trim", range, re[t3.COMPARATORTRIM]);
...
var InputField = class {
  ...
  toTS() {
    const property2 = buildInputField(this.field, this.prefixFilter, this.noEnumerable, this.genericsInfo, this.source);
    return stringify(property2);
  }
};
__name(InputField, "InputField");
function buildInputField(field, prefixFilter = false, noEnumerable = false, genericsInfo, source) {
...
function buildSingleFieldType(t3, prefixFilter, noEnumerable = false, genericsInfo, source) {
  let type;
  if (typeof t3.type === "string") {
    ...
    if (!scalarType) {
      type = namedInputType(t3.type);
    } else if (Array.isArray(scalarType)) {
      type = unionType(scalarType.map(namedInputType));
    } else {
      type = namedInputType(scalarType);
    }
  } else if (prefixFilter) {
    type = namedInputType(`Base${t3.type.name}`);
  } else {
...
function buildAllFieldTypes(inputTypes, prefixFilter, noEnumerable = false, genericsInfo, source) {
  ...
  const tsInputObjectTypes = inputObjectTypes.map(
    (type) => buildSingleFieldType(type, prefixFilter, noEnumerable, genericsInfo, source)
  );
  const tsOtherTypes = otherTypes.map(
    (type) => buildSingleFieldType(type, prefixFilter, noEnumerable, genericsInfo, source)
  );
...
${(0, import_indent_string9.default)(
          `objects: {
${(0, import_indent_string9.default)(
            model.fields.filter((f3) => f3.kind === "object").map((field) => new ModelOutputField(this.dmmf, field, false).toTS()).join("\n"),
            TAB_SIZE
          )}
}`,
          TAB_SIZE
...
${(0, import_indent_string9.default)(
            model.fields.filter((f3) => f3.kind === "scalar" || f3.kind === "enum").map((field) => new ModelOutputField(this.dmmf, field, !this.dmmf.typeMap[field.type]).toTS()).join("\n"),
            TAB_SIZE
          )}
