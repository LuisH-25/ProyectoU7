...
var require_symlink_paths = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/ensure/symlink-paths.js"(exports, module2) {
    ...
    function symlinkPathsSync(srcpath, dstpath) {
      let exists2;
      if (path3.isAbsolute(srcpath)) {
        exists2 = fs4.existsSync(srcpath);
        if (!exists2)
        ...
        const dstdir = path3.dirname(dstpath);
        const relativeToDst = path3.join(dstdir, srcpath);
        exists2 = fs4.existsSync(relativeToDst);
        if (exists2) {
          return {
            toCwd: relativeToDst,
            toDst: srcpath
...
var require_semver = __commonJS({
  "../../node_modules/.pnpm/semver@6.3.0/node_modules/semver/semver.js"(exports, module2) {
    ...
    Range.prototype.parseRange = function(range) {
      ...
      debug4("comparator trim", range, re[t2.COMPARATORTRIM]);
...
async function getSSLVersion(args) {
  ...
  const libsslSpecificPaths = K(args).with({ distro: "musl" }, () => {
    ...
    debug2(`Don't know any platform-specific paths for "${distro}" on ${arch}`);
    return [];
  });
  const libsslSpecificCommands = libsslSpecificPaths.map((path3) => `ls ${path3} | grep libssl.so`);
